    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7772), 1, 0 },
                    { 2, 2, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7783), 2, 0 },
                    { 3, 3, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7784), 3, 0 },
                    { 4, 4, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7785), 4, 0 },
                    { 5, 5, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7786), 5, 0 },
                    { 6, 6, 15, new DateTime(2022, 8, 5, 9, 59, 16, 779, DateTimeKind.Local).AddTicks(7787), 8, 0 }
                });
