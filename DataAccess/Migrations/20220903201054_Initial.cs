    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7925), 1, 0 },
                    { 2, 2, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7936), 2, 0 },
                    { 3, 3, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7937), 3, 0 },
                    { 4, 4, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7938), 4, 0 },
                    { 5, 5, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7939), 5, 0 },
                    { 6, 6, 15, new DateTime(2022, 9, 3, 23, 10, 54, 420, DateTimeKind.Local).AddTicks(7940), 8, 0 }
                });
